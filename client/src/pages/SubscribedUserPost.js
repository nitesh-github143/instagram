    ...
    return (
        <div className="flex flex-col items-center">
            {isLoading ? (
                ...
                data.map(item => (
                    <div key={item._id} className="max-w-xl w-full bg-white shadow-2xl rounded-lg p-4 mb-8">
                        <div className="flex items-center mb-4">
                            <img className="w-12 h-12 rounded-full mr-4 object-cover" src={item.postedBy?.pic} alt="Profile" />
                            <div>
                                <Link to={item.postedBy?._id ? `/profile/${item.postedBy._id}` : '/profile'}>
                        ...
                        <div className="mb-4">
                            <img className="w-full rounded-lg" src={item.photo} alt="Post" />
                        </div>
                        ...
                        <div className="mt-4">
                            {item.comments.slice(0, showAllComments ? item.comments.length : 2).map((comment, index) => (
